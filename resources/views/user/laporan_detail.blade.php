...
<div class="container py-5">
    ...
    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3 mb-4">
        <div>
            <h2 class="fw-bold text-primary mb-1">Detail Laporan</h2>
            <p class="text-muted mb-0">Informasi lengkap hasil rekomendasi obat yang telah dikirim ke Admin.</p>
        </div>
        <a href="{{ route('laporan') }}" class="btn btn-outline-secondary btn-lg">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start gap-3 mb-4">
                        <div>
                            ...
                            <p class="text-muted mb-0">Ringkasan rekomendasi yang dikirim ke Admin dan status PDF.</p>
                        </div>
